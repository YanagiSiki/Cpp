...
#include <iostream>
int main() {
    int test_digit,test_group,test_year,test_month,test_day;
    string test_stu,test_gro;


    cin>>test_digit>>test_stu;
    Student a(test_digit,test_stu);//建立學生資料
    Student b(111111111,"kami");

    cin>>test_group>>test_year>>test_month>>test_day>>test_gro;
    Group kon(test_group,a,test_year,test_month,test_day,test_gro);//建立社團資料
